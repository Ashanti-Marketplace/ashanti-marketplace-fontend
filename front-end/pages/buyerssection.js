...
const BuyersSection = () => {
  return (
    <div className={styles.buyersSection}>
      ...
      <div className={styles.collectAndDesign}>Collect and design online</div>
      <div className={styles.buyersSectionChild} />
      ...
      <b className={styles.artworks}>1,993,700 Artworks:</b>
      <div className={styles.buyersSectionItem} />
      <div className={styles.buyersSectionInner} />
      <div className={styles.lineDiv} />
      <div className={styles.buyersSectionChild1} />
      <div className={styles.buyersSectionChild2} />
      <div className={styles.buyersSectionChild3} />
      <div className={styles.rectangleParent}>
        <img className={styles.frameInner} alt="" src="/rectangle-49@2x.png" />
      ...
      <div className={styles.rectangleContainer}>
        <img className={styles.frameInner} alt="" src="/rectangle-55@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent}>
      ...
      <div className={styles.rectangleParent1}>
        <img className={styles.frameInner} alt="" src="/rectangle-58@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent}>
      ...
      <div className={styles.rectangleParent2}>
        <img className={styles.frameInner} alt="" src="/rectangle-61@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent}>
      ...
      <div className={styles.rectangleParent3}>
        <img className={styles.frameChild4} alt="" src="/rectangle-48@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent}>
      ...
      <div className={styles.rectangleParent4}>
        <img className={styles.frameChild5} alt="" src="/rectangle-51@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent}>
      ...
      <div className={styles.rectangleParent5}>
        <img className={styles.frameChild5} alt="" src="/rectangle-54@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent}>
      ...
      <div className={styles.rectangleParent6}>
        <img className={styles.frameChild5} alt="" src="/rectangle-57@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent}>
      ...
      <div className={styles.rectangleParent7}>
        <img className={styles.frameChild5} alt="" src="/rectangle-60@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent7}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent7}>
              <img
                className={styles.materialSymbolssearchRoundeIcon}
                alt=""
      ...
      <div className={styles.rectangleParent8}>
        <img className={styles.frameChild9} alt="" src="/rectangle-47@2x.png" />
        <div className={styles.frameGroup}>
          <div className={styles.modernTheFutureParent}>
            <div className={styles.explore}>Modern: The future</div>
            <div className={styles.mdicardsHeartOutlineParent}>
      ...
      <div className={styles.enterASearch}>Enter a search term</div>
      <img
      ...
      />
      <img
        className={styles.materialSymbolssearchRoundeIcon1}
        alt=""
        src="/materialsymbolssearchrounded1.svg"
      />
      <img
      ...
      <img
        ...
        alt=""
        src="/materialsymbolskeyboardarrowuprounded2.svg"
      />
      <img
        className={styles.materialSymbolskeyboardArroIcon3}
        alt=""
        src="/materialsymbolskeyboardarrowuprounded3.svg"
      />
      <img
        className={styles.materialSymbolskeyboardArroIcon4}
        alt=""
        src="/materialsymbolskeyboardarrowuprounded4.svg"
      />
      <div className={styles.frameParent13}>
        <div className={styles.instanceParent}>
          ...
          <div className={styles.explore}>Onah Wilson</div>
        </div>
        <div className={styles.instanceParent}>
          <div className={styles.rectangleWrapper}>
            <div className={styles.instanceChild} />
          </div>
          <div className={styles.explore}>Kayode David</div>
        </div>
        <div className={styles.instanceParent}>
          <div className={styles.rectangleWrapper}>
            <div className={styles.instanceChild} />
        ...
        <div className={styles.instanceParent}>
          ...
          <div className={styles.explore}>Oghenetega Bright</div>
        </div>
      </div>
      <div className={styles.frameParent14}>
        <div className={styles.instanceParent}>
          <div className={styles.frameChild14} />
          <div className={styles.explore}>Unique</div>
        </div>
        <div className={styles.instanceParent}>
          <div className={styles.frameChild14} />
          <div className={styles.explore}>Limited Edition</div>
        </div>
        <div className={styles.instanceParent}>
          <div className={styles.frameChild14} />
          <div className={styles.explore}>African theme</div>
        </div>
      </div>
      <div className={styles.frameParent15}>
        <div className={styles.instanceParent}>
          ...
          <div className={styles.explore}>Red</div>
        </div>
        <div className={styles.instanceParent}>
          <div className={styles.rectangleWrapper}>
            <div className={styles.instanceChild} />
          </div>
          <div className={styles.explore}>Yellow</div>
        </div>
        <div className={styles.instanceParent}>
          <div className={styles.rectangleWrapper}>
            <div className={styles.instanceChild} />
          </div>
          <div className={styles.explore}>Green</div>
        </div>
        <div className={styles.instanceParent}>
          <div className={styles.rectangleWrapper}>
            <div className={styles.instanceChild} />
          </div>
          <div className={styles.explore}>Purple</div>
        </div>
        <div className={styles.instanceParent}>
          <div className={styles.rectangleWrapper}>
            <div className={styles.instanceChild} />
          </div>
          <div className={styles.explore}>Blue</div>
        </div>
      </div>
      <div className={styles.min}>Min</div>
      <div className={styles.n0}>
        <b>N</b>
        <span>0</span>
      </div>
      <div className={styles.n500000}>N500000+</div>
      <div className={styles.n}>N</div>
      <div className={styles.n1}>N</div>
      <div className={styles.max}>Max</div>
      <div className={styles.buyersSectionChild4} />
      <div className={styles.buyersSectionChild5} />
      <div className={styles.buyersSectionChild6} />
      <div className={styles.ellipseDiv} />
      <div className={styles.buyersSectionChild7} />
      <div className={styles.rectangleParent16}>
        ...
        />
        <div className={styles.explore}>Abstract</div>
      </div>
      <div className={styles.rectangleParent17}>
        ...
        />
        <div className={styles.explore}>Contemporary</div>
      </div>
      <div className={styles.rectangleParent18}>
        ...
        />
        <div className={styles.explore}>Painting</div>
      </div>
      <div className={styles.materialSymbolskeyboardArroParent}>
        <img
          className={styles.materialSymbolssearchRoundeIcon}
          alt=""
          src="/materialsymbolskeyboardarrowuprounded5.svg"
        />
      ...
      <div className={styles.materialSymbolskeyboardArroGroup}>
        <img
          className={styles.materialSymbolssearchRoundeIcon}
          alt=""
          src="/materialsymbolskeyboardarrowuprounded6.svg"
        />
