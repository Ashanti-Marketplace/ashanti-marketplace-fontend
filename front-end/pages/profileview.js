...
const profileview = () => {
  ...
  <div className="flex flex-row gap-6 items-center mb-12 mx-16">
    ...
    <div className="border-solid border-[#d9f3dd] flex flex-row justify-between mr-24 w-1/2 h-12 items-center pl-8 pr-6 border rounded-lg">
      ...
      <img
        src="https://file.rendit.io/n/kY66UUp2tnZnyAvvRaTi.svg"
    ...
    <img
      src="https://file.rendit.io/n/zrjkfkDIAaCbpyiDgGj1.svg"
      className="min-h-0 min-w-0 w-8 shrink-0"
    />
    <img
      src="https://file.rendit.io/n/QWspH6eDK4I6TUy53k9Z.svg"
      className="min-h-0 min-w-0 w-8 shrink-0"
    />
  </div>
  <div className="border-solid border-[#273b2d] mb-20 h-px shrink-0 border-t border-b-0 border-x-0" />
  <div className="self-start flex flex-row gap-5 items-center mb-40 ml-16">
    <img
      src="https://file.rendit.io/n/cJWNumP5RGzsVhfgltMg.png"
      className="min-h-0 min-w-0"
    />
    <div className="flex flex-col gap-2 w-64 shrink-0">
      <div className="whitespace-nowrap text-5xl font-['Ubuntu'] text-white">
        Mary Sokoh
      </div>
      <div className="whitespace-nowrap text-2xl font-['Inter'] text-[#748479] mr-6">
        Member since 2023
      </div>
    </div>
  </div>
  <div className="flex flex-row justify-between items-center mb-3 mx-[235px]">
    <div className="text-2xl font-['Ubuntu'] text-white w-16 shrink-0">
      Saves
    </div>
    <div className="text-2xl font-['Ubuntu'] text-[#526658] w-20 shrink-0">
      Follows
    </div>
  </div>
  ...
  <div className="flex flex-row gap-5 items-center mb-1 mx-16">
    <img
      src="https://file.rendit.io/n/qchWEoootxqVI6uZYXQB.png"
      className="min-h-0 min-w-0 mr-px"
    />
    <div className="self-start flex flex-col gap-1 items-center">
      <img
        src="https://file.rendit.io/n/vSQJS4K2kAKFkA3Cc3m2.png"
      ...
      <div className="self-stretch flex flex-row ml-px gap-4 items-center">
        ...
        <img
          src="https://file.rendit.io/n/EoBkO59SvBGNaGzhJdkD.svg"
          className="min-h-0 min-w-0 w-8 shrink-0"
        />
        <img
          src="https://file.rendit.io/n/g3Jj38vNcVW0vywWI5ty.svg"
          className="min-h-0 min-w-0 w-8 shrink-0"
        />
      </div>
    ...
    <div className="self-start flex flex-col gap-1 items-center">
      <img
        src="https://file.rendit.io/n/OAQBceebKRCDzYgoANol.png"
        className="min-h-0 min-w-0 mb-6"
      />
      <div className="self-stretch flex flex-row ml-px gap-4 items-center">
        <div className="whitespace-nowrap text-lg font-['Inter'] text-white mr-12 w-1/2">
    ...
    <img
      src="https://file.rendit.io/n/mss2Vn3CpHBrf6ZvqyAg.png"
      className="min-h-0 min-w-0"
    />
  </div>
  <div className="flex flex-row gap-4 items-center mb-3 mx-16">
    <div className="self-end flex flex-col mr-1 gap-1 items-center">
      <div className="self-stretch flex flex-row gap-4 items-center">
        ...
        />
        <img
          src="https://file.rendit.io/n/1akXnrjq6Dk03VSS4Eee.svg"
          className="min-h-0 min-w-0 w-8 shrink-0"
        />
      </div>
      ...
      <img
        src="https://file.rendit.io/n/9X5A5U8u4FDsvyhDdYNW.png"
        className="min-h-0 min-w-0"
      />
    </div>
    <img
      src="https://file.rendit.io/n/gFZuW8JMItl14WPrAiI5.png"
      className="min-h-0 min-w-0 mr-px"
    />
    <img
      src="https://file.rendit.io/n/nIBYjJplFw9TqyZ9aW4r.png"
      className="min-h-0 min-w-0"
    />
    <div className="self-start flex flex-col mt-2 gap-px items-center">
      ...
      <img
        src="https://file.rendit.io/n/x8e4xp5YlXSiF4wxY3Xe.png"
        className="min-h-0 min-w-0"
      />
    </div>
  </div>
  ...
  <div className="flex flex-row gap-4 items-center mb-1 mx-16">
    <img
      src="https://file.rendit.io/n/hwY4xcej0GqHgA7YHete.png"
      className="min-h-0 min-w-0 mr-px"
    />
    <div className="self-start flex flex-col mr-px gap-1 items-center">
      <img
        src="https://file.rendit.io/n/wKTpFaa2VGHZhAQxyPnf.png"
    ...
    <div className="self-start flex flex-col gap-1 items-center">
      <img
        src="https://file.rendit.io/n/71FPxMbelQ6Wd1FVtSHN.png"
        className="min-h-0 min-w-0 mb-3"
      />
    ...
    <img
      src="https://file.rendit.io/n/vhpGaorweIh12wAxnBEb.png"
      className="min-h-0 min-w-0"
    />
  </div>
  <div className="flex flex-row gap-4 items-center mb-3 mx-16">
    <div className="self-end flex flex-col mr-px gap-1 items-center">
      ...
      <img
        src="https://file.rendit.io/n/QwKYwYtDcH9OQfbzhw9s.png"
        className="min-h-0 min-w-0"
      />
    </div>
    <img
      src="https://file.rendit.io/n/kqrplP6o5Ck1QFMdF3j3.png"
      className="min-h-0 min-w-0 mr-1"
    />
    <img
      src="https://file.rendit.io/n/HdXpoYf4ozuwOb6jKyWY.png"
      className="min-h-0 min-w-0"
    />
    <div className="self-start flex flex-col mt-2 gap-1 items-center">
      ...
      <img
        src="https://file.rendit.io/n/Vj5hQljR6m25e8UUXVzT.png"
        className="min-h-0 min-w-0"
      />
    </div>
  </div>
  ...
  <div className="self-center flex flex-row mb-20 gap-2 w-3/5 items-center">
    <img
      src="https://file.rendit.io/n/RDzZr4r7qfthunCuKFRT.svg"
      className="min-h-0 min-w-0 w-8 shrink-0"
    />
    ...
    <img
      src="https://file.rendit.io/n/cdYpV6Dr4LkJQn48gsRX.svg"
      className="min-h-0 min-w-0 w-8 shrink-0"
    />
  </div>
